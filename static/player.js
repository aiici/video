...
var MacPlayer = {
    ...
    'Play': function() {
        ...
        document.write('<scr' + 'ipt src="' + this.Path + this.PlayFrom + '.js?t=0032"></scr' + 'ipt>')
    },
    'Down': function() {},
    'Init': function() {
        this.Status = true;
        ...
        this.Thumb = player_data.vod_pic_thumb;
        this.Vodname = player_data.vod_title + '+' + player_data.vod_title_name;
        ...
        if (!$.trim(player_data.link_next)) {
            this.PlayNewLinkNext = player_data.link_next;
        } else {
            this.PlayNewLinkNext = "https://" + document.domain + player_data.link_next;
        }
